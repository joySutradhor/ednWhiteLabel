...
const CollaborateSection = () => {
    return (
        <div className="2xl:pt-[200px] xl:pt-[100px] lg:pt-[80px] md:pt-[60px] pt-[50px]">
            <div>
                <div className="bg-black xl:px-[50px] xl:py-[40px] xl:rounded-[5px] 2xl:px-[100px] 2xl:py-[50px] 2xl:rounded-[10px] lg:py-[30px] lg:rounded-[5px] lg:px-[30px] md:py-[30px] md:px-[30px] py-[30px] px-[30px] text-white">
                    <div className="flex justify-between items-center">
                        <div className="2xl:w-[60%] xl:w-[50%] lg:w-[55%] md:w-[55%] w-[100%]">
                            ...
                            {/*============= side cards mobile ========== */}
                            <div className="grid grid-cols-3 gap-[21.55px] md:hidden block">
